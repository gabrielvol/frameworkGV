/* * NombreDeProyecto * ========================================================
   Captcha Get Token [/src/js/_capctha_formIniciarSesion.js]
   ========================================================================== */
...
// Request captcha token
        grecaptcha.execute(captcha_key_site, {action: 'formIniciarSesion'}).then(function(token) {
            
// Set token as the value of `data_captchaResponseToken__formIniciarSesion` hidden field
            data_captchaResponseToken__formIniciarSesion.value = token;
