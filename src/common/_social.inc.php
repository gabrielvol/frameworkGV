<ul class="social unstyled displayFlex">
    <li class="social_em">
        <a <?php echo $site_email_contacto_href; ?> class="hover_grow_L_ani">
    ...
    <li class="social_fb">
        <a href="<?php echo $social_facebook_url; ?>" class="hover_grow_L_ani">
            ...
            <img src="<?php echo $dir_env; ?>/img/social_fb.svg" alt="<?php echo _('Ir a nuestro perfil en Facebook'); ?>.">
        </a>
    </li>
    <li class="social_ig">
        <a href="<?php echo $social_instagram_url; ?>" class="hover_grow_L_ani">
            ...
            <img src="<?php echo $dir_env; ?>/img/social_ig.svg" alt="<?php echo _('Ir a nuestro perfil en Instagram'); ?>.">
        </a>
    </li>
    <li class="social_li">
