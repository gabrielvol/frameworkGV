<ul class="social horizontal clearfix">
    <li class="fb">
        <a href="/framework/" class="fb displayBlock hoverGrow mhaBT indentedText" title="<?php echo _('Seguinos en Facebook'); ?>">
            <?php echo _("Seguinos en Facebook"); ?>
            <img src="/img/soc_fb.svg" class="svg displayBlock" alt="<?php echo _('&Iacute;cono de Facebook'); ?>">
        </a></li>
    <li class="tw">
        <a href="/framework/" class="tw displayBlock hoverGrow mhaBT indentedText" title="<?php echo _('Seguinos en Twitter'); ?>">
            <?php echo _("Seguinos en Twitter"); ?>
            <img src="/img/soc_tw.svg" class="svg displayBlock" alt="<?php echo _('&Iacute;cono de Twitter'); ?>">
        </a></li>
    <li class="ig">
        <a href="/framework/" class="ig displayBlock hoverGrow mhaBT indentedText" title="<?php echo _('Seguinos en Instagram'); ?>">
            <?php echo _("Seguinos en Instagram"); ?>
            <img src="/img/soc_ig.svg" class="svg displayBlock" alt="<?php echo _('&Iacute;cono de Instagram'); ?>">
        </a></li>
    <li class="pi">
        <a href="/framework/" class="pi displayBlock hoverGrow mhaBT indentedText" title="<?php echo _('Seguinos en Pinterest'); ?>">
            <?php echo _("Seguinos en Pinterest"); ?>
            <img src="/img/soc_pi.svg" class="svg displayBlock" alt="<?php echo _('&Iacute;cono de Pinterest'); ?>">
        </a></li>
    <li class="yt">
        <a href="/framework/" class="yt displayBlock hoverGrow mhaBT indentedText" title="<?php echo _('Mir&aacute; Nuestro Canal en YouTube'); ?>">
    ...
    <li class="li">
        <a href="/framework/" class="li displayBlock hoverGrow mhaBT indentedText" title="<?php echo _('Mir&aacute; nuestro perfil en LinkedIn'); ?>">
    ...
    <li class="sp">
        <a href="/framework/" class="sp displayBlock hoverGrow mhaBT indentedText" title="<?php echo _('Escuchanos en Spotify'); ?>">
