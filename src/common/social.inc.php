<ul class="social horizontal clearfix">
    ...
    <li class="li">
        <a href="/nuevo/" class="li displayBlock hoverGrow mhaBT indentedText">
    ...
    <li class="sp">
        <a href="/nuevo/" class="sp displayBlock hoverGrow mhaBT indentedText">
