...
<form method="post" enctype="multipart/form-data" class="mha" id="<?php echo $form_id; ?>" name="<?php echo $form_id; ?>">
    ...
    <label for="data_nombre__formMainID" class="<?php echo $form_validation_input_class_data_nombre__formMainID; ?>">
        ...
        <?php else: ?>
            Nombre
        <?php endif; ?></span>
        <input type="text" name="data_nombre__formMainID" id="data_nombre__formMainID" class="data_nombre__formMainID <?php echo $form_validation_input_class_data_nombre__formMainID; ?>" value="<?php echo $_POST['data_nombre__formMainID']; ?>" form="formMainID" enterkeyhint="next" placeholder="<?php if(isset($gettext_lang) && $gettext_lang == 'en_GB') { echo ''; } else { echo ''; } ?>" <?php echo $form_input_autofocus_data_nombre__formMainID; ?>>
    ...
    <label for="data_apellido__formMainID" class="<?php echo $form_validation_input_class_data_apellido__formMainID; ?>">
        ...
        <?php else: ?>
            Apellido
        <?php endif; ?></span>
        <input type="text" name="data_apellido__formMainID" id="data_apellido__formMainID" class="data_apellido__formMainID <?php echo $form_validation_input_class_data_apellido__formMainID; ?>" value="<?php echo $_POST['data_apellido__formMainID']; ?>" form="formMainID" enterkeyhint="next" placeholder="<?php if(isset($gettext_lang) && $gettext_lang == 'en_GB') { echo ''; } else { echo ''; } ?>" <?php echo $form_input_autofocus_data_apellido__formMainID; ?>>
    ...
    <label for="data_nombreAp__formMainID" class="<?php echo $form_validation_input_class_data_nombreAp__formMainID; ?>">
        ...
        <?php else: ?>
            Nombre y Apellido
        <?php endif; ?></span>
        <input type="text" name="data_nombreAp__formMainID" id="data_nombreAp__formMainID" class="data_nombreAp__formMainID <?php echo $form_validation_input_class_data_nombreAp__formMainID; ?>" value="<?php echo $_POST['data_nombreAp__formMainID']; ?>" form="formMainID" enterkeyhint="next" placeholder="<?php if(isset($gettext_lang) && $gettext_lang == 'en_GB') { echo ''; } else { echo ''; } ?>" <?php echo $form_input_autofocus_data_nombreAp__formMainID; ?>>
    ...
    <label for="data_username__formMainID" class="<?php echo $form_validation_input_class_data_username__formMainID; ?>">
        ...
        <?php else: ?>
            Nombre de usuario
        <?php endif; ?></span>
        <input type="text" name="data_username__formMainID" id="data_username__formMainID" class="data_username__formMainID <?php echo $form_validation_input_class_data_username__formMainID; ?>" value="<?php echo $_POST['data_username__formMainID']; ?>" form="formMainID" enterkeyhint="next" placeholder="<?php if(isset($gettext_lang) && $gettext_lang == 'en_GB') { echo ''; } else { echo ''; } ?>" <?php echo $form_input_autofocus_data_username__formMainID; ?>>
    ...
    <label for="data_genero__formMainID" class="<?php echo $form_validation_input_class_data_genero__formMainID; ?>">
        ...
        <?php else: ?>
            Género
        <?php endif; ?></span>
        <input type="text" name="data_genero__formMainID" id="data_genero__formMainID" class="data_genero__formMainID <?php echo $form_validation_input_class_data_genero__formMainID; ?>" value="<?php echo $_POST['data_genero__formMainID']; ?>" form="formMainID" enterkeyhint="next" placeholder="<?php if(isset($gettext_lang) && $gettext_lang == 'en_GB') { echo ''; } else { echo ''; } ?>" <?php echo $form_input_autofocus_data_genero__formMainID; ?>>
    ...
    <label for="data_password__formMainID" class="<?php echo $form_validation_input_class_data_password__formMainID; ?>">
        ...
        <?php else: ?>
            Contraseña
        <?php endif; ?></span>
        <input type="password" name="contrasena__formMainID" id="data_password__formMainID" class="data_password__formMainID <?php echo $form_validation_input_class_data_password__formMainID; ?>" value="<?php echo $_POST['contrasena__formMainID']; ?>" form="formMainID" enterkeyhint="go" placeholder="<?php if(isset($gettext_lang) && $gettext_lang == 'en_GB') { echo ''; } else { echo ''; } ?>" <?php echo $form_input_autofocus_data_password__formMainID; ?>>
    ...
    <label for="data_ciudad__formMainID" class="<?php echo $form_validation_input_class_data_ciudad__formMainID; ?>">
        ...
        <?php else: ?>
            Ciudad
        <?php endif; ?></span>
        <input type="text" name="data_ciudad__formMainID" id="data_ciudad__formMainID" class="data_ciudad__formMainID <?php echo $form_validation_input_class_data_ciudad__formMainID; ?>" value="<?php echo $_POST['data_ciudad__formMainID']; ?>" form="formMainID" enterkeyhint="next" placeholder="<?php if(isset($gettext_lang) && $gettext_lang == 'en_GB') { echo ''; } else { echo ''; } ?>" <?php echo $form_input_autofocus_data_ciudad__formMainID; ?>>
    ...
    <label for="data_localidad__formMainID" class="<?php echo $form_validation_input_class_data_localidad__formMainID; ?>">
        ...
        <?php else: ?>
            Localidad
        <?php endif; ?></span>
        <input type="text" name="data_localidad__formMainID" id="data_localidad__formMainID" class="data_localidad__formMainID <?php echo $form_validation_input_class_data_localidad__formMainID; ?>" value="<?php echo $_POST['data_localidad__formMainID']; ?>" form="formMainID" enterkeyhint="next" placeholder="<?php if(isset($gettext_lang) && $gettext_lang == 'en_GB') { echo ''; } else { echo ''; } ?>" <?php echo $form_input_autofocus_data_localidad__formMainID; ?>>
    ...
    <label for="data_direccion__formMainID" class="<?php echo $form_validation_input_class_data_direccion__formMainID; ?>">
        ...
        <?php else: ?>
            Dirección
        <?php endif; ?></span>
        <input type="text" name="data_direccion__formMainID" id="data_direccion__formMainID" class="data_direccion__formMainID <?php echo $form_validation_input_class_data_direccion__formMainID; ?>" value="<?php echo $_POST['data_direccion__formMainID']; ?>" form="formMainID" enterkeyhint="next" placeholder="<?php if(isset($gettext_lang) && $gettext_lang == 'en_GB') { echo ''; } else { echo ''; } ?>" <?php echo $form_input_autofocus_data_direccion__formMainID; ?>>
    ...
    <label for="data_domicilio__formMainID" class="<?php echo $form_validation_input_class_data_domicilio__formMainID; ?>">
        ...
        <?php else: ?>
            Domicilio
        <?php endif; ?></span>
        <input type="text" name="data_domicilio__formMainID" id="data_domicilio__formMainID" class="data_domicilio__formMainID <?php echo $form_validation_input_class_data_domicilio__formMainID; ?>" value="<?php echo $_POST['data_domicilio__formMainID']; ?>" form="formMainID" enterkeyhint="next" placeholder="<?php if(isset($gettext_lang) && $gettext_lang == 'en_GB') { echo ''; } else { echo ''; } ?>" <?php echo $form_input_autofocus_data_domicilio__formMainID; ?>>
    ...
    <label for="data_celular__formMainID" class="<?php echo $form_validation_input_class_data_celular__formMainID; ?>">
        ...
        <?php else: ?>
            Celular
        <?php endif; ?></span>
        <input type="tel" inputmode="tel" pattern="[0-9]*" min="0" name="data_celular__formMainID" id="data_celular__formMainID" class="data_celular__formMainID <?php echo $form_validation_input_class_data_celular__formMainID; ?>" value="<?php echo $_POST['data_celular__formMainID']; ?>" form="formMainID" enterkeyhint="next" placeholder="<?php if(isset($gettext_lang) && $gettext_lang == 'en_GB') { echo ''; } else { echo ''; } ?>" <?php echo $form_input_autofocus_data_celular__formMainID; ?>>
    ...
    <label for="data_instagram__formMainID" class="<?php echo $form_validation_input_class_data_instagram__formMainID; ?>">
        ...
        <?php else: ?>
            Instagram
        <?php endif; ?></span>
        <input type="text"  inputmode="email" name="data_instagram__formMainID" id="data_instagram__formMainID" class="data_instagram__formMainID <?php echo $form_validation_input_class_data_instagram__formMainID; ?>" value="<?php echo $_POST['data_instagram__formMainID']; ?>" form="formMainID" enterkeyhint="next" placeholder="<?php if(isset($gettext_lang) && $gettext_lang == 'en_GB') { echo 'Just write the username'; } else { echo 'Solamente escribir el usuario'; } ?>" <?php echo $form_input_autofocus_data_instagram__formMainID; ?>> 
    ...
    <label for="data_empresa__formMainID" class="<?php echo $form_validation_input_class_data_empresa__formMainID; ?>">
        ...
        <input type="text" name="data_empresa__formMainID" id="data_empresa__formMainID" class="data_empresa__formMainID <?php echo $form_validation_input_class_data_empresa__formMainID; ?>" value="<?php echo $_POST['data_empresa__formMainID']; ?>" form="formMainID" enterkeyhint="next" placeholder="<?php if(isset($gettext_lang) && $gettext_lang == 'en_GB') { echo ''; } else { echo ''; } ?>" <?php echo $form_input_autofocus_data_empresa__formMainID; ?>>
    ...
    <label for="data_cargo__formMainID" class="<?php echo $form_validation_input_class_data_cargo__formMainID; ?>">
        ...
        <?php else: ?>
            Cargo
        <?php endif; ?></span>
        <input type="text" name="data_cargo__formMainID" id="data_cargo__formMainID" class="data_cargo__formMainID <?php echo $form_validation_input_class_data_cargo__formMainID; ?>" value="<?php echo $_POST['data_cargo__formMainID']; ?>" form="formMainID" enterkeyhint="next" placeholder="<?php if(isset($gettext_lang) && $gettext_lang == 'en_GB') { echo ''; } else { echo ''; } ?>" <?php echo $form_input_autofocus_data_cargo__formMainID; ?>>
    ...
    <label for="data_cantidad__formMainID" class="<?php echo $form_validation_input_class_data_cantidad__formMainID; ?>">
        ...
        <?php else: ?>
            Cantidad
        <?php endif; ?></span>
        <input type="number" pattern="[0-9]*" min="0" name="data_cantidad__formMainID" id="data_cantidad__formMainID" class="cantidad <?php echo $form_validation_input_class_data_cantidad__formMainID; ?>" value="<?php echo $_POST['data_cantidad__formMainID']; ?>" form="formMainID" enterkeyhint="next" placeholder="<?php if(isset($gettext_lang) && $gettext_lang == 'en_GB') { echo ''; } else { echo ''; } ?>" <?php echo $form_input_autofocus_data_cantidad__formMainID; ?>>
    ...
    <label for="data_fecha__formMainID" class="<?php echo $form_validation_input_class_data_fecha__formMainID; ?>">
        ...
        <?php else: ?>
            Fecha
        <?php endif; ?></span>
        <input type="date" name="data_fecha__formMainID" id="data_fecha__formMainID" class="data_fecha__formMainID <?php echo $form_validation_input_class_data_fecha__formMainID; ?>" value="<?php echo $_POST['data_fecha__formMainID']; ?>" form="formMainID" enterkeyhint="next" placeholder="<?php if(isset($gettext_lang) && $gettext_lang == 'en_GB') { echo 'Please select a date'; } else { echo 'Seleccione una fecha en el calendario'; } ?>" <?php echo $form_input_autofocus_data_fecha__formMainID; ?>>
    ...
    <label for="data_mensaje__formMainID" class="form_required <?php echo $form_validation_input_class_data_mensaje__formMainID; ?>">
        ...
        <?php endif; ?></span>
        <textarea name="data_mensaje__formMainID" id="data_mensaje__formMainID" class="data_mensaje__formMainID <?php echo $form_validation_input_class_data_mensaje__formMainID; ?>" form="formMainID" placeholder="<?php if(isset($gettext_lang) && $gettext_lang == 'en_GB') { echo 'Write your message here'; } else { echo 'Escriba aqu&iacute; su mensaje'; } ?>" <?php echo $form_input_autofocus_data_mensaje__formMainID; ?> required><?php echo $_POST['data_mensaje__formMainID']; ?></textarea>
    ...
    <label lang="<?php echo $site_lang_HTML_attr; ?>" for="data_mensaje__formMainID">
        ...
        <?php else: ?>
            Mensaje
        <?php endif; ?></span>
        <textarea name="data_mensaje__formMainID" id="data_mensaje__formMainID" class="data_mensaje__formMainID" form="formMainID" placeholder="<?php if(isset($gettext_lang) && $gettext_lang == 'en_GB') { echo 'Write your message here'; } else { echo 'Escriba aqu&iacute; su mensaje'; } ?>"><?php echo $_POST['data_mensaje__formMainID']; ?></textarea>
    </label>
