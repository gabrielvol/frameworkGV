<form method="post" class="mha" id="formMainID">
    ...
    <label for="data_nombreAp__formMain">
        ...
        <input type="text" name="data_nombreAp__formMain" id="data_nombreAp__formMain" class="data_nombreAp__formMain <?php echo $form_validation_input_class_data_nombreAp__formMain; ?>" value="<?php echo $_POST['data_nombreAp__formMain']; ?>" form="formMainID" enterkeyhint="next" placeholder="<?php echo _(''); ?>" <?php echo $form_input_autofocus_data_nombreAp__formMain; ?>>
    ...
    <label for="data_nombreCo__formMain">
        ...
        <input type="text" name="data_nombreCo__formMain" id="data_nombreCo__formMain" class="data_nombreCo__formMain <?php echo $form_validation_input_class_data_nombreCo__formMain; ?>" value="<?php echo $_POST['data_nombreCo__formMain']; ?>" form="formMainID" enterkeyhint="next" placeholder="<?php echo _(''); ?>" <?php echo $form_input_autofocus_data_nombreCo__formMain; ?>>
    ...
    <label for="data_username__formMain">
        ...
        <input type="text" name="data_username__formMain" id="data_username__formMain" class="data_username__formMain <?php echo $form_validation_input_class_data_username__formMain; ?>" value="<?php echo $_POST['data_username__formMain']; ?>" form="formMainID" enterkeyhint="next" placeholder="<?php echo _(''); ?>" <?php echo $form_input_autofocus_data_username__formMain; ?>>
    ...
    <label for="data_domicilio__formMain">
        ...
        <input type="text" name="data_domicilio__formMain" id="data_domicilio__formMain" class="data_domicilio__formMain <?php echo $form_validation_input_class_data_domicilio__formMain; ?>" value="<?php echo $_POST['data_domicilio__formMain']; ?>" form="formMainID" enterkeyhint="next" placeholder="<?php echo _(''); ?>" <?php echo $form_input_autofocus_data_domicilio__formMain; ?>>
    ...
    <label for="data_localidad__formMain">
        ...
        <input type="text" name="data_localidad__formMain" id="data_localidad__formMain" class="data_localidad__formMain <?php echo $form_validation_input_class_data_localidad__formMain; ?>" value="<?php echo $_POST['data_localidad__formMain']; ?>" form="formMainID" enterkeyhint="next" placeholder="<?php echo _(''); ?>" <?php echo $form_input_autofocus_data_localidad__formMain; ?>>
    ...
    <label for="data_ciudad__formMain">
        ...
        <input type="text" name="data_ciudad__formMain" id="data_ciudad__formMain" class="data_ciudad__formMain <?php echo $form_validation_input_class_data_ciudad__formMain; ?>" value="<?php echo $_POST['data_ciudad__formMain']; ?>" form="formMainID" enterkeyhint="next" placeholder="<?php echo _(''); ?>" <?php echo $form_input_autofocus_data_ciudad__formMain; ?>>
    ...
    <label for="data_provincia__formMain">
        ...
        <input type="text" name="data_provincia__formMain" id="data_provincia__formMain" class="data_provincia__formMain <?php echo $form_validation_input_class_data_provincia__formMain; ?>" value="<?php echo $_POST['data_provincia__formMain']; ?>" form="formMainID" enterkeyhint="next" placeholder="<?php echo _(''); ?>" <?php echo $form_input_autofocus_data_provincia__formMain; ?>>
    ...
    <label for="data_GENERICSELECT__formMain">
        ...
        <select name="data_GENERICSELECT__formMain" id="data_GENERICSELECT__formMain" class="data_GENERICSELECT__formMain <?php echo $form_validation_input_class_data_GENERICSELECT__formMain; ?>" form="formMainID" enterkeyhint="next">
    ...
    <label for="data_pais__formMain">
        ...
        <input type="text" name="data_pais__formMain" id="data_pais__formMain" class="data_pais__formMain <?php echo $form_validation_input_class_data_pais__formMain; ?>" value="<?php echo $_POST['data_pais__formMain']; ?>" form="formMainID" enterkeyhint="next" placeholder="<?php echo _(''); ?>" <?php echo $form_input_autofocus_data_pais__formMain; ?>>
    ...
    <label for="data_telefono__formMain">
        ...
        <input type="tel" name="data_telefono__formMain" id="data_telefono__formMain" class="data_telefono__formMain <?php echo $form_validation_input_class_data_telefono__formMain; ?>" value="<?php echo $_POST['data_telefono__formMain']; ?>" form="formMainID" enterkeyhint="next" placeholder="<?php echo _(''); ?>" <?php echo $form_input_autofocus_data_telefono__formMain; ?>>
    ...
    <label for="data_email__formMain">
        ...
        <input type="email" name="data_email__formMain" id="data_email__formMain" class="data_email__formMain <?php echo $form_validation_input_class_data_email__formMain; ?>" value="<?php echo $_POST['data_email__formMain']; ?>" form="formMainID" enterkeyhint="next" placeholder="<?php echo _(''); ?>" <?php echo $form_input_autofocus_data_email__formMain; ?>>
    ...
    <label for="data_webSite__formMain">
        <span class="form_label_name"><?php echo _('Sitio web'); ?></span>
        <input type="text" name="data_webSite__formMain" id="data_webSite__formMain" class="data_webSite__formMain <?php echo $form_validation_input_class_data_webSite__formMain; ?>" value="<?php echo $_POST['data_webSite__formMain']; ?>" form="formMainID" enterkeyhint="next" placeholder="" <?php echo $form_input_autofocus_data_webSite__formMain; ?>>
        <span class="form_validation_span <?php echo $form_validation_span_class_data_webSite__formMain; ?>"><?php echo $form_validation_span_msg_data_webSite__formMain; ?></span>
    </label>          

    <label for="data_facebook__formMain">
        <span class="form_label_name"><?php echo _('Perfil de Facebook'); ?></span>
        <input type="url" name="data_facebook__formMain" id="data_facebook__formMain" class="data_facebook__formMain <?php echo $form_validation_input_class_data_facebook__formMain; ?>" value="<?php echo $_POST['data_facebook__formMain']; ?>" form="formMainID" enterkeyhint="next" placeholder="<?php echo _('Debe comenzar con http://www.facebook.com/'); ?>" <?php echo $form_input_autofocus_data_facebook__formMain; ?>>
    ...
    <label for="data_instagram__formMain">
        ...
        <input type="text" name="data_instagram__formMain" id="data_instagram__formMain" class="data_instagram__formMain <?php echo $form_validation_input_class_data_instagram__formMain; ?>" value="<?php echo $_POST['data_instagram__formMain']; ?>" form="formMainID" enterkeyhint="next" placeholder="<?php echo _('Sólo escribí tu usuario'); ?>" <?php echo $form_input_autofocus_data_instagram__formMain; ?>>
    ...
    <label for="data_rubro__formMain">
        ...
        <input type="text" name="data_rubro__formMain" id="data_rubro__formMain" class="data_rubro__formMain <?php echo $form_validation_input_class_data_rubro__formMain; ?>" value="<?php echo $_POST['data_rubro__formMain']; ?>" form="formMainID" enterkeyhint="next" placeholder="<?php echo _(''); ?>" <?php echo $form_input_autofocus_data_rubro__formMain; ?>>
    ...
    <label for="data_cargo__formMain">
        ...
        <input type="text" name="data_cargo__formMain" id="data_cargo__formMain" class="data_cargo__formMain <?php echo $form_validation_input_class_data_cargo__formMain; ?>" value="<?php echo $_POST['data_cargo__formMain']; ?>" form="formMainID" enterkeyhint="next" placeholder="<?php echo _(''); ?>" <?php echo $form_input_autofocus_data_cargo__formMain; ?>>
    ...
    <label for="data_cantidad__formMain">
        ...
        <input type="text" inputmode="numeric" name="data_cantidad__formMain" id="data_cantidad__formMain" class="cantidad <?php echo $form_validation_input_class_data_cantidad__formMain; ?>" value="<?php echo $_POST['data_cantidad__formMain']; ?>" form="formMainID" enterkeyhint="next" placeholder="<?php echo _(''); ?>" <?php echo $form_input_autofocus_data_cantidad__formMain; ?>>
    ...
    <label for="data_fecha__formMain">
        ...
        <input type="date" name="data_fecha__formMain" id="data_fecha__formMain" class="data_fecha__formMain <?php echo $form_validation_input_class_data_fecha__formMain; ?>" value="<?php echo $_POST['data_fecha__formMain']; ?>" form="formMainID" enterkeyhint="next" placeholder="<?php echo _('Seleccione una fecha en el calendario'); ?>" <?php echo $form_input_autofocus_data_fecha__formMain; ?>>
    ...
    <fieldset class="<?php echo $form_validation_input_class_data_newsletter__formMain; ?>">
        ...
        <label for="data_newsletterSi__formMain" class="radio">
            <input type="radio" name="data_newsletter__formMain" id="data_newsletterSi__formMain" form="formMainID" value="<?php echo _('Si'); ?>" <?php echo $form_input_autofocus_data_newsletter__formMain; ?>>
            <span><?php echo _('S&iacute;'); ?></span>
        </label>

        <label for="data_newsletterNo__formMain" class="radio">
            <input type="radio" name="data_newsletter__formMain" id="data_newsletterNo__formMain" form="formMainID" value="<?php echo _('No'); ?>">
            <span><?php echo _('No'); ?></span>
        </label>

        <label for="data_newsletterNoSe__formMain" class="radio">
            <input type="radio" name="data_newsletter__formMain" id="data_newsletterNoSe__formMain" form="formMainID" value="<?php echo _('No S&eacute;'); ?>">
    ...
    <label for="data_mensaje__formMain">
        ...
        <textarea name="data_mensaje__formMain" id="data_mensaje__formMain" class="data_mensaje__formMain <?php echo $form_validation_input_class_data_mensaje__formMain; ?>" form="formMainID" placeholder="<?php echo _('Escriba aqu&iacute; su mensaje') ?>" <?php echo $form_input_autofocus_data_mensaje__formMain; ?>><?php echo $_POST['data_mensaje__formMain']; ?></textarea>
