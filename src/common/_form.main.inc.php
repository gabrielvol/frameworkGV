<form method="post" class="mha" id="formID">
    ...
    <label for="data_nombre__formMain">
        ...
        <input type="text" name="data_nombre__formMain" id="data_nombre__formMain" class="nombre <?php echo $form_validation_input_class_data_nombre__formMain; ?>" value="<?php echo $_POST['data_nombre__formMain']; ?>" form="formID" enterkeyhint="next" placeholder="<?php echo _(''); ?>" <?php echo $form_input_autofocus_data_nombre__formMain; ?>>
    ...
    <label for="data_apellido__formMain">
        ...
        <input type="text" name="data_apellido__formMain" id="data_apellido__formMain" class="apellido <?php echo $form_validation_input_class_data_apellido__formMain; ?>" value="<?php echo $_POST['data_apellido__formMain']; ?>" form="formID" enterkeyhint="next" placeholder="<?php echo _(''); ?>" <?php echo $form_input_autofocus_data_apellido__formMain; ?>>
    ...
    <label for="data_nombreAp__formMain">
        ...
        <input type="text" name="data_nombreAp__formMain" id="data_nombreAp__formMain" class="nombreApe <?php echo $form_validation_input_class_data_nombreAp__formMain; ?>" value="<?php echo $_POST['data_nombreAp__formMain']; ?>" form="formID" enterkeyhint="next" placeholder="<?php echo _(''); ?>" <?php echo $form_input_autofocus_data_nombreAp__formMain; ?>>
    ...
    <label for="data_nombreCo__formMain">
        ...
        <input type="text" name="data_nombreCo__formMain" id="data_nombreCo__formMain" class="nombreComp <?php echo $form_validation_input_class_data_nombreCo__formMain; ?>" value="<?php echo $_POST['data_nombreCo__formMain']; ?>" form="formID" enterkeyhint="next" placeholder="<?php echo _(''); ?>" <?php echo $form_input_autofocus_data_nombreCo__formMain; ?>>
    ...
    <label for="data_username__formMain">
        ...
        <input type="text" name="data_username__formMain" id="data_username__formMain" class="username <?php echo $form_validation_input_class_data_username__formMain; ?>" value="<?php echo $_POST['data_username__formMain']; ?>" form="formID" enterkeyhint="next" placeholder="<?php echo _(''); ?>" <?php echo $form_input_autofocus_data_username__formMain; ?>>
    ...
    <label for="data_genero__formMain">
        ...
        <select name="data_genero__formMain" id="data_genero__formMain" class="genero" form="formID" enterkeyhint="next">
    ...
    <label for="data_genero__formMain">
        <span class="form_label_name"><?php echo _('Género'); ?></span>
        <input type="text" name="data_genero__formMain" id="data_genero__formMain" class="genero <?php echo $form_validation_input_class_data_genero__formMain; ?>" value="<?php echo $_POST['data_genero__formMain']; ?>" form="formID" enterkeyhint="next" placeholder="<?php echo _(''); ?>" <?php echo $form_input_autofocus_data_genero__formMain; ?>>
    ...
    <label for="data_genero__formMain">
        <span class="form_label_name"><?php echo _('Género'); ?></span>                    
        <input type="text" list="genero_listaTotal" name="data_genero__formMain" form="formID" enterkeyhint="next">
    ...
    <label for="data_dni__formMain">
        ...
        <input type="text" inputmode="numeric" name="data_dni__formMain" id="data_dni__formMain" class="dni <?php echo $form_validation_input_class_data_dni__formMain; ?>" value="<?php echo $_POST['data_dni__formMain']; ?>" form="formID" enterkeyhint="next" placeholder="<?php echo _(''); ?>" <?php echo $form_input_autofocus_data_dni__formMain; ?>>
    ...
    <label for="data_password__formMain">
        ...
        <input type="password" name="contrasena__formMain" id="contrasena__formMain" class="contrasena <?php echo $form_validation_input_class_data_password__formMain; ?>" value="<?php echo $_POST['contrasena__formMain']; ?>" form="formID" enterkeyhint="go" placeholder="<?php echo _(''); ?>" <?php echo $form_input_autofocus_data_password__formMain; ?>>
    ...
    <label for="data_localidad__formMain">
        ...
        <input type="text" name="data_localidad__formMain" id="data_localidad__formMain" class="localidad <?php echo $form_validation_input_class_data_localidad__formMain; ?>" value="<?php echo $_POST['data_localidad__formMain']; ?>" form="formID" enterkeyhint="next" placeholder="<?php echo _(''); ?>" <?php echo $form_input_autofocus_data_localidad__formMain; ?>>
    ...
    <label for="data_ciudad__formMain">
        ...
        <input type="text" name="data_ciudad__formMain" id="data_ciudad__formMain" class="ciudad <?php echo $form_validation_input_class_data_ciudad__formMain; ?>" value="<?php echo $_POST['data_ciudad__formMain']; ?>" form="formID" enterkeyhint="next" placeholder="<?php echo _(''); ?>" <?php echo $form_input_autofocus_data_ciudad__formMain; ?>>
    ...
    <label for="data_provincia__formMain">
        ...
        <input type="text" name="data_provincia__formMain" id="data_provincia__formMain" class="provincia <?php echo $form_validation_input_class_data_provincia__formMain; ?>" value="<?php echo $_POST['data_provincia__formMain']; ?>" form="formID" enterkeyhint="next" placeholder="<?php echo _(''); ?>" <?php echo $form_input_autofocus_data_provincia__formMain; ?>>
    ...
    <label for="data_provincia__formMain">
        <span class="form_label_name"><?php echo _('Provincia'); ?></span>
        <select id="data_provincia__formMain" name="data_provincia__formMain" class="provincia <?php echo $form_validation_input_class_data_provincia__formMain; ?>" form="formID" enterkeyhint="next">
    ...
    <label for="data_comoQueres__formMain">
        ...
        <select id="data_comoQueres__formMain" name="data_comoQueres__formMain" class="comoQueres <?php echo $form_validation_input_class_data_comoQueres__formMain; ?>" form="formID" enterkeyhint="next">
    ...
    <label for="data_GENERICSELECT__formMain">
        ...
        <select id="data_GENERICSELECT__formMain" name="data_GENERICSELECT__formMain" class="GENERICSELECT <?php echo $form_validation_input_class_data_GENERICSELECT__formMain; ?>" form="formID" enterkeyhint="next">
    ...
    <label for="data_pais__formMain">
        ...
        <input type="text" name="data_pais__formMain" id="data_pais__formMain" class="pais <?php echo $form_validation_input_class_data_pais__formMain; ?>" value="<?php echo $_POST['data_pais__formMain']; ?>" form="formID" enterkeyhint="next" placeholder="<?php echo _(''); ?>" <?php echo $form_input_autofocus_data_pais__formMain; ?>>
    ...
    <label for="data_celular__formMain">
        ...
        <input type="tel" name="data_celular__formMain" id="data_celular__formMain" class="telefono <?php echo $form_validation_input_class_data_celular__formMain; ?>" value="<?php echo $_POST['data_celular__formMain']; ?>" form="formID" enterkeyhint="next" placeholder="<?php echo _(''); ?>" <?php echo $form_input_autofocus_data_celular__formMain; ?>>
    ...
    <label for="data_telefono__formMain">
        ...
        <input type="tel" name="data_telefono__formMain" id="data_telefono__formMain" class="telefono <?php echo $form_validation_input_class_data_telefono__formMain; ?>" value="<?php echo $_POST['data_telefono__formMain']; ?>" form="formID" enterkeyhint="next" placeholder="<?php echo _(''); ?>" <?php echo $form_input_autofocus_data_telefono__formMain; ?>>
    ...
    <label for="data_email__formMain">
        ...
        <input type="email" name="data_email__formMain" id="data_email__formMain" class="email <?php echo $form_validation_input_class_data_email__formMain; ?>" value="<?php echo $_POST['data_email__formMain']; ?>" form="formID" enterkeyhint="next" placeholder="<?php echo _(''); ?>" <?php echo $form_input_autofocus_data_email__formMain; ?>>
    ...
    <label for="data_webSite__formMain">
        <span class="form_label_name"><?php echo _('Sitio web'); ?></span>
        <input type="text" name="data_webSite__formMain" id="data_webSite__formMain" class="website <?php echo $form_validation_input_class_data_webSite__formMain; ?>" value="<?php echo $_POST['data_webSite__formMain']; ?>" form="formID" enterkeyhint="next" placeholder="" <?php echo $form_input_autofocus_data_webSite__formMain; ?>>
        <span class="form_validation_span <?php echo $form_validation_span_class_data_webSite__formMain; ?>"><?php echo $form_validation_span_msg_data_webSite__formMain; ?></span>
    </label>          

    <label for="data_facebook__formMain">
        <span class="form_label_name"><?php echo _('Perfil de Facebook'); ?></span>
        <input type="url" name="data_facebook__formMain" id="data_facebook__formMain" class="facebook <?php echo $form_validation_input_class_data_facebook__formMain; ?>" value="<?php echo $_POST['data_facebook__formMain']; ?>" form="formID" enterkeyhint="next" placeholder="<?php echo _('Debe comenzar con http://www.facebook.com/'); ?>" <?php echo $form_input_autofocus_data_facebook__formMain; ?>>
    ...
    <label for="data_empresa__formMain">
        ...
        <input type="text" name="data_empresa__formMain" id="data_empresa__formMain" class="empresa <?php echo $form_validation_input_class_data_empresa__formMain; ?>" value="<?php echo $_POST['data_empresa__formMain']; ?>" form="formID" enterkeyhint="next" placeholder="<?php echo _(''); ?>" <?php echo $form_input_autofocus_data_empresa__formMain; ?>>
    ...
    <label for="data_razonSocial__formMain">
        ...
        <input type="text" name="data_razonSocial__formMain" id="data_razonSocial__formMain" class="razonSocial <?php echo $form_validation_input_class_data_razonSocial__formMain; ?>" value="<?php echo $_POST['data_razonSocial__formMain']; ?>" form="formID" enterkeyhint="next" placeholder="<?php echo _(''); ?>" <?php echo $form_input_autofocus_data_razonSocial__formMain; ?>>
    ...
    <label for="data_rubro__formMain">
        ...
        <input type="text" name="data_rubro__formMain" id="data_rubro__formMain" class="rubro <?php echo $form_validation_input_class_data_rubro__formMain; ?>" value="<?php echo $_POST['data_rubro__formMain']; ?>" form="formID" enterkeyhint="next" placeholder="<?php echo _(''); ?>" <?php echo $form_input_autofocus_data_rubro__formMain; ?>>
    ...
    <label for="data_cargo__formMain">
        ...
        <input type="text" name="data_cargo__formMain" id="data_cargo__formMain" class="cargo <?php echo $form_validation_input_class_data_cargo__formMain; ?>" value="<?php echo $_POST['data_cargo__formMain']; ?>" form="formID" enterkeyhint="next" placeholder="<?php echo _(''); ?>" <?php echo $form_input_autofocus_data_cargo__formMain; ?>>
    ...
    <label for="data_fecha__formMain">
        ...
        <input type="date" name="data_fecha__formMain" id="data_fecha__formMain" class="fecha <?php echo $form_validation_input_class_data_fecha__formMain; ?>" value="<?php echo $_POST['data_fecha__formMain']; ?>" form="formID" enterkeyhint="next" placeholder="<?php echo _('Seleccione una fecha en el calendario'); ?>" <?php echo $form_input_autofocus_data_fecha__formMain; ?>>
    ...
    <label for="data_precioTilde__formMain">
        ...
        <input type="checkbox" name="data_precioTilde__formMain" id="data_precioTilde__formMain" class="check preciotilde" form="formID" value="Si">
    </label>

    <label for="data_browser__formMain">
        <?php echo _('Choose a browser from this list:'); ?>
        <input type="text" list="browser_dataList" name="data_browser__formMain" id="data_browser__formMain" form="formID" enterkeyhint="next">
    ...
    <label for="data_asunto__formMain">
        ...
        <input type="text" name="data_asunto__formMain" id="data_asunto__formMain" class="asunto <?php echo $form_validation_input_class_data_asunto__formMain; ?>" value="<?php echo $_POST['data_asunto__formMain']; ?>" form="formID" enterkeyhint="next" placeholder="<?php echo _(''); ?>" <?php echo $form_input_autofocus_data_asunto__formMain; ?>>
    ...
    <label for="data_area__formMain">
        ...
        <select id="data_area__formMain" name="data_area__formMain" class="area <?php echo $form_validation_input_class_data_area__formMain; ?>" form="formID" enterkeyhint="next">
    ...
    <label for="data_mensaje__formMain">
        ...
        <textarea name="data_mensaje__formMain" id="data_mensaje__formMain" class="mensaje <?php echo $form_validation_input_class_data_mensaje__formMain; ?>" form="formID" placeholder="<?php echo _('Escriba aqu&iacute; su mensaje') ?>" <?php echo $form_input_autofocus_data_mensaje__formMain; ?>><?php echo $_POST['data_mensaje__formMain']; ?></textarea>
    ...
    <label for="data_mensaje__formMain">
        ...
        <textarea name="data_mensaje__formMain" id="data_mensaje__formMain" class="mensaje" form="formID" placeholder="<?php echo _('Escriba aqu&iacute; su mensaje') ?>"><?php echo $_POST['data_mensaje__formMain']; ?></textarea>
    </label>
