...
$form_status_error_globalC__formMainID    = 'Puede comunicarse enviando un mensaje por correo electr&oacute;nico a <a href="' . $form_status_recipient_mailto__global . '" class="' . $form_status_pop_anchor_classes__formMainID . '">' . $form_status_recipient__global . '</a>';
