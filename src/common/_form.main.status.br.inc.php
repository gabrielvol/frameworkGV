...
$form_status_error_globalC__formMainID    = 'Você pode entrar em contato enviando um e-mail para <a href="' . $form_status_recipient_mailto__global . '" class="' . $form_status_pop_anchor_classes__formMainID . '">' . $form_status_recipient__global . '</a>';
