...
<a href="#main" id="go-main-content"><?php if(isset($gettext_lang) && $gettext_lang == 'en_GB'): ?>Go to the main content of the site.<?php else: ?>Ir al contenido principal de esta p&aacute;gina.<?php endif; ?></a>
