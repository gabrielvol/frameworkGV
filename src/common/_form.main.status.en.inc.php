...
$form_status_error_globalC__formMainID    = 'You can contact us by email writing to <a href="' . $form_status_recipient_mailto__global . '" class="' . $form_status_pop_anchor_classes__formMainID . '">' . $form_status_recipient__global . '</a>';
