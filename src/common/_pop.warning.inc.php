<div class="pop_global pop_warning" role="alertdialog" aria-labelledby="idlabelledby">
    <div role="document" tabindex="0">
        ...
        <button type="button" class="button_pop_submit bgWhite mtl mha arial bold black alignCenter upperCase" aria-pressed="false"><?php echo _("OK"); ?></button>
    </div>
</div>
<div class="modal_global modal_warning displayNone"></div>