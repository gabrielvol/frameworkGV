        ...
        <div class="mobileForm tabletForm">
            <form method="post" class="mha" id="formID">
                ...
                <label for="data_nombre__formName">
                    ...
                    <span class="formInputErrorMsg <?php echo $formSpan_error_class_data_nombre__formName ?>"><?php echo $formSpan_error_MSG_data_nombre__formName ?></span>
                </label>
                ...
                <label for="data_apellido__formName">
                    ...
                    <span class="formInputErrorMsg <?php echo $formSpan_error_class_data_apellido__formName ?>"><?php echo $formSpan_error_MSG_data_apellido__formName ?></span>
                </label>
                ...
                <label for="data_nombreAp__formName">
                    ...
                    <span class="formInputErrorMsg <?php echo $formSpan_error_class_data_nombreAp__formName ?>"><?php echo $formSpan_error_MSG_data_nombreAp__formName ?></span>
                </label>
                ...
                <label for="data_nombreCo__formName">
                    ...
                    <span class="formInputErrorMsg <?php echo $formSpan_error_class_data_nombreCo__formName ?>"><?php echo $formSpan_error_MSG_data_nombreCo__formName ?></span>
                </label>
                ...
                <label for="data_username__formName">
                    ...
                    <span class="formInputErrorMsg <?php echo $formSpan_error_class_data_username__formName ?>"><?php echo $formSpan_error_MSG_data_username__formName ?></span>
                </label>
                ...
                <label for="data_password__formName">
                    ...
                    <span class="formInputErrorMsg <?php echo $formSpan_error_class_data_password__formName ?>"><?php echo $formSpan_error_MSG_data_password__formName ?></span>        
                ...
                <label for="data_direccion__formName">
                    ...
                    <span class="formInputErrorMsg <?php echo $formSpan_error_class_data_direccion__formName ?>"><?php echo $formSpan_error_MSG_data_direccion__formName ?></span>
                </label>
                ...
                <label for="data_domicilio__formName">
                    ...
                    <span class="formInputErrorMsg <?php echo $formSpan_error_class_data_domicilio__formName ?>"><?php echo $formSpan_error_MSG_data_domicilio__formName ?></span>
                </label>
                ...
                <label for="data_localidad__formName">
                    ...
                    <span class="formInputErrorMsg <?php echo $formSpan_error_class_data_localidad__formName ?>"><?php echo $formSpan_error_MSG_data_localidad__formName ?></span>
                </label>
                ...
                <label for="data_GENERICSELECT__formName">
                    ...
                    <span class="formInputErrorMsg <?php echo $formSpan_error_class_data_GENERICSELECT__formName ?>"><?php echo $formSpan_error_MSG_data_GENERICSELECT__formName ?></span>
                </label>
                ...
                <label for="data_telefono__formName">
                    ...
                    <span class="formInputErrorMsg <?php echo $formSpan_error_class_data_telefono__formName ?>"><?php echo $formSpan_error_MSG_data_telefono__formName ?></span>
                </label>
                ...
                <label for="data_email__formName">
                    ...
                    <span class="formInputErrorMsg <?php echo $formSpan_error_class_data_email__formName ?>"><?php echo $formSpan_error_MSG_data_email__formName ?></span>  
                    <span class="formSugg">Te enviaremos un correo a esta casilla para confirmar tu registro.</span>
                </label> 
                ...
                <label for="data_webSite__formName">
                    ...
                    <span class="formInputErrorMsg <?php echo $formSpan_error_class_data_webSite__formName ?>"><?php echo $formSpan_error_MSG_data_webSite__formName ?></span>
                </label>              
                ...
                <label for="data_facebook__formName">
                    ...
                    <span class="formInputErrorMsg <?php echo $formSpan_error_class_data_facebook__formName ?>"><?php echo $formSpan_error_MSG_data_facebook__formName ?></span>
                </label>       
                ...
                <label for="data_instagram__formName">
                    ...
                    <span class="formInputErrorMsg <?php echo $formSpan_error_class_data_instagram__formName ?>"><?php echo $formSpan_error_MSG_data_instagram__formName ?></span>        
                    <span class="formSugg">Te enviaremos un correo a esta casilla para confirmar tu registro.</span>
                </label>
                ...
                <label for="data_empresa__formName">
                    ...
                    <span class="formInputErrorMsg <?php echo $formSpan_error_class_data_empresa__formName ?>"><?php echo $formSpan_error_MSG_data_empresa__formName ?></span>
                </label>
                ...
                <label for="data_razonSocial__formName">
                    ...
                    <span class="formInputErrorMsg <?php echo $formSpan_error_class_data_razonSocial__formName ?>"><?php echo $formSpan_error_MSG_data_razonSocial__formName ?></span>
                </label>
                ...
                <label for="data_rubro__formName">
                    ...
                    <span class="formInputErrorMsg <?php echo $formSpan_error_class_data_rubro__formName ?>"><?php echo $formSpan_error_MSG_data_rubro__formName ?></span>
                </label>
                ...
                <label for="data_cargo__formName">
                    ...
                    <span class="formInputErrorMsg <?php echo $formSpan_error_class_data_cargo__formName ?>"><?php echo $formSpan_error_MSG_data_cargo__formName ?></span>
                </label>
                ...
                <label for="data_fecha__formName">
                    ...
                    <span class="formInputErrorMsg <?php echo $formSpan_error_class_data_fecha__formName ?>"><?php echo $formSpan_error_MSG_data_fecha__formName ?></span>
                </label>
                ...
                <label for="data_asunto__formName">
                    ...
                    <span class="formInputErrorMsg <?php echo $formSpan_error_class_data_asunto__formName ?>"><?php echo $formSpan_error_MSG_data_asunto__formName ?></span>
                </label> 
                ...
                <label for="data_area__formName">
                    ...
                    <select id="data_area__formName" name="data_area__formName" class="area <?php echo $formInput_error_class_data_area__formName ?>">
                        ...
                        <option value="<?php echo $company_email_a ?>"><?php echo _('aaaa'); ?> - <?php echo $company_email_a ?></option>
                        <option value="<?php echo $company_email_b ?>"><?php echo _('bbbb'); ?> - <?php echo $company_email_b ?></option>
                    </select>
