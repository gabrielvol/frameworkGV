	...
	<div id="main" class="int contacto" role="main">
            ...
            <form method="post" name="" action="">
                ...
                <label for="fecha">
                    ...
                    <span class="sug"><?php echo _('Ingrese una fecha'); ?></span>
                    <input type="date" name="fecha" id="fecha" class="fecha <?php echo $invalidFieldFecha ?>" value="<?php echo $_POST['fecha']; ?>" placeholder="<?php echo _('Ingrese su fecha'); ?>" <?php echo $autofocusFecha ?>>
