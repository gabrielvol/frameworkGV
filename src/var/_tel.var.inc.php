...
$tel_code_country_YYYY          = '52'; // REF [13]
...
// $tel_code_area_YYYY              = '2325';
// $tel_code_area_YYYY_int          = '02325';
    
// $tel_prefix_YYYY_whatsapp        = $tel_code_country_YYYY . $tel_code_area_YYYY_int;
// $tel_prefix_YYYY_call            = $tel_code_country_YYYY . $tel_code_area_YYYY;  
// $tel_prefix_YYYY_formatted       = '(02325)';       
...
// $site_tel_YYYY_formatted             = $tel_prefix_YYYY_formatted . ' ' . $site_tel_YYYY_a. '-' .$site_tel_YYYY_b;
    
// $site_tel_YYYY_whatsapp              = $tel_prefix_YYYY_whatsapp . $site_tel_YYYY;
// $site_tel_YYYY_whatsapp_formatted    = '+' . $tel_code_country_YYYY . ' ' . $tel_code_area_YYYY_int . $site_tel_YYYY_a . ' ' . $site_tel_YYYY_b;
...
// $site_tel_YYYY_call                  = 'tel:+' . $tel_prefix_YYYY_call . $site_tel_YYYY;
// $site_tel_YYYY_call_href             = 'href="tel:+' . $tel_prefix_YYYY_call . $site_tel_YYYY . '"';
