...
<body>
    ...
    <div id="main" class="container" role="main">
        <ul class="slick slick_main mask horizontal clearfix">
            <li><img data-lazy="/nuevo/img/slide_01.jpg" alt="" aria-hidden="true"></li>
            <li><img data-lazy="/nuevo/img/slide_02.jpg" alt="" aria-hidden="true"></li>
            <li><img data-lazy="/nuevo/img/slide_03.jpg" alt="" aria-hidden="true"></li>
        </ul>
        
        <ul class="slick slick_main mask horizontal clearfix">
            <li><img src="/nuevo/img/slide_01.jpg" alt="" aria-hidden="true"></li>
            <li><img src="/nuevo/img/slide_02.jpg" alt="" aria-hidden="true"></li>
            <li><img src="/nuevo/img/slide_03.jpg" alt="" aria-hidden="true"></li>
        </ul>
    </div>
