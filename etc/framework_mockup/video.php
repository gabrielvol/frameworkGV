...
<body>
    ...
    <div id="main" class="container" role="main">
        <video width="320" height="240" poster="/framework/video/poster.jpg" controls preload="none">
            <!-- MP4 for Safari, IE9, iPhone, iPad, Android, and Windows Phone 7 -->
            <source src="/video/index.mp4" type='video/mp4; codecs="avc1.42E01E, mp4a.40.2"' />
            <!-- WebM/VP8 for Firefox4, Opera, and Chrome -->
            <source src="/framework/video/video.webm" type='video/webm; codecs="vp8, vorbis"' />
            <!-- Ogg/Vorbis for older Firefox and Opera versions -->
            <source src="/video/index.ogv" type='video/ogg; codecs="theora, vorbis"'/>
            <!-- Optional: Add subtitles for each language -->
            <track kind="subtitles" src="/framework/video/subs.srt" srclang="en" />
            <!-- Optional: Add chapters -->
            <track kind="chapters" src="/framework/video/chapters.srt" srclang="en" />
            <!-- Flash fallback for non-HTML5 browsers without JavaScript -->
            <object width="320" height="240" type="application/x-shockwave-flash" data="/framework/video/video.swf">
